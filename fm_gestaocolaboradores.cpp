    ...
    ui(new Ui::fm_gestaoColaboradores)
{
    ...
    ui->tw_ge_listacolab->setColumnWidth(1,150);
...
void fm_gestaoColaboradores::on_btn_gravar_novocolab_clicked()
{
    ...
    if(!query.exec()){
        QMessageBox::critical(this,"ERRO","Erro ao inserir novo colaborador","OK");
    }else{
        QMessageBox::information(this,"GRAVADO","Colaborador gravado com sucesso","OK");
        ui->txt_nome_novocolab->clear();
        ui->txt_username_novocolab->clear();
        ui->txt_senha_novocolab->clear();
        ui->txt_fone_novocolab->clear();
...
void fm_gestaoColaboradores::on_tabWidget_currentChanged(int index)
{
    if(index==1){
        ...
        if(query.exec()){
            ...
            QMessageBox::warning(this,"ERRO","Erro ao listar colaboradores","OK");
        }
...
void fm_gestaoColaboradores::on_btn_ge_salvar_clicked()
{
    if(ui->tw_ge_listacolab->currentRow()==-1){
        QMessageBox::warning(this,"ERRO","Selecione um colaborador","OK");
        return;
    }
    ...
    if(query.exec()){
        ...
        QMessageBox::information(this,"Atualizado","Colaborador atualizado com sucesso","OK");
    }else{
        QMessageBox::warning(this,"ERRO","Erro ao atualizar colaborador","OK");
    }
...
void fm_gestaoColaboradores::on_btn_ge_excluir_clicked()
{
    ...
    if(opc==QMessageBox::Yes){
        ...
        if(query.exec()){
            ...
            QMessageBox::information(this,"DELETADO","Colaborador deletado com sucesso","OK");
        }else{
            QMessageBox::warning(this,"ERRO","Erro ao excluir colaborador","OK");
        }
    }
